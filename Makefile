...
export BCDS_APP_NAME = StreamSensorDataOverUsb
...
export BCDS_XDK_APP_SOURCE_FILES = \
	...
	$(BCDS_APP_SOURCE_DIR)/StreamSensorDataOverUsb.c \
	$(BCDS_APP_SOURCE_DIR)/Accelerometer.c \
	$(BCDS_APP_SOURCE_DIR)/EnvironmentalSensor.c \
	$(BCDS_APP_SOURCE_DIR)/Gyroscope.c \
	$(BCDS_APP_SOURCE_DIR)/InertialSensor.c \
	$(BCDS_APP_SOURCE_DIR)/Magnetometer.c \
	$(BCDS_APP_SOURCE_DIR)/LightSensor.c \
