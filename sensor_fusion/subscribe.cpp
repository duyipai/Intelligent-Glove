...
#define RESET_VECILOTY_COUNTER 30
...

{
	...
	void message_arrived(mqtt::const_message_ptr msg) override
	{
		...
		states.w[0] = (Est.eulerRoll() - states.roll)/(t-states.t);
		states.w[1] = (Est.eulerPitch() - states.pitch)/(t-states.t);
		states.w[2] = (Est.eulerYaw() - states.yaw)/(t-states.t);
		...
		if (coutCounter % 50 == 0)
		{
			...
			std::cout << " Vx: " << states.v[0] << " Vy: " << states.v[1] << " Vz: " << states.v[2] << std::endl;
		}
	}
