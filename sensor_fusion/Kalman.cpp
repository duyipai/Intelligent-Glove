...
Kalman::Kalman(const float Gravity, const float *State, const float *Covariance,
...
void Kalman::updateIMU(const float *Gyroscope, const float *Accelerometer, const float h) {
...
void Kalman::getState(float *State) {
	State[0] = x0;
	State[1] = x1;
	State[2] = x2;
	State[3] = x3;
...
void Kalman::getCovariance(float *Covariance) {
	Covariance[0] = P00;
	Covariance[1] = P01;
	Covariance[2] = P02;
	Covariance[3] = P03;
...
void Kalman::getNGAcc(float *ngacc) {
	ngacc[0] = a0;
	ngacc[1] = a1;
	ngacc[2] = a2;
}
